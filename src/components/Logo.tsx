  ...
  return (
    <Link href="/" className={`flex items-center ${className.includes("h-") ? "" : "h-16"}`}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 140" fill="none" className={className}>
        ...
        <text x="142" y="60" font-family="'The Delicate DEMO','Sora','Inter',sans-serif" font-size="44" font-weight="400" fill="#f5f5f5" letter-spacing="3.5">LAB</text>
        <text x="248" y="64" font-family="'Simple Pleasure','Sora','Inter',sans-serif" font-size="48" font-weight="400" fill="url(#lb1)" letter-spacing="4">Y</text>
