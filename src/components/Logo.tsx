  ...
  return (
    <Link href="/" className={`flex items-center ${className.includes("h-") ? "" : "h-16"}`}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 140" fill="none" className={className}>
        <defs>
          ...
          <mask id="zxm">
            ...
            <g stroke="#000" stroke-width="10" stroke-linecap="round" stroke-linejoin="round">
              <line x1="24" y1="18" x2="96" y2="102"/>
              <line x1="96" y1="18" x2="24" y2="102"/>
            </g>
          </mask>
        </defs>
        <circle cx="70" cy="70" r="62" fill="url(#zxg)"/>
        <g>
          <circle cx="60" cy="60" r="48" fill="url(#zx1)" mask="url(#zxm)"/>
          <g stroke="#f0a0a0" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" fill="none" opacity="0.5">
            <line x1="24" y1="18" x2="96" y2="102"/>
            <line x1="96" y1="18" x2="24" y2="102"/>
          </g>
          <circle cx="24" cy="18" r="2.5" fill="#f0a0a0" filter="url(#zeg)" opacity="0.7"/>
          <circle cx="96" cy="18" r="2.5" fill="#e07070" filter="url(#zeg)" opacity="0.7"/>
          <circle cx="24" cy="102" r="2.5" fill="#e07070" filter="url(#zeg)" opacity="0.7"/>
          <circle cx="96" cy="102" r="2.5" fill="#d64b5a" filter="url(#zeg)" opacity="0.7"/>
        </g>
        ...
        <text x="142" y="94" font-family="'Space Grotesk','Inter',sans-serif" font-size="11.5" fill="#777" letter-spacing="5.5" font-weight="500">Innovating Intelligence</text>
        <line x1="142" y1="111" x2="370" y2="111" stroke="url(#zx1)" stroke-width="1" opacity="0.15"/>
      </svg>
    </Link>
  );
}
